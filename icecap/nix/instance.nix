...
mkInstance (self: with self; {
  ...
  veracruz-test = pkgs_linux.icecap.callPackage ./binaries/veracruz-test.nix {};
  ...
  veracruzTestElf = ../build/veracruz-test/out/veracruz-test;
  ...
  veracruzTestElfInContext = runCommand "veracruz-test" {} ''
    mkdir -p $out/bin
    cp ${veracruzTestElf} $out/bin/veracruz-test
  '';

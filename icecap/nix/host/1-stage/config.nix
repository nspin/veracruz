...

{
  config = {
    ...
    '' + ''
      ...
      date -s '@${builtins.readFile ../../../build/NOW}' # HACK
    '';

    initramfs.extraUtilsCommands = ''
      copy_bin_and_libs ${instance.veracruzServerTestElfInContext}/bin/veracruz-server-test
      copy_bin_and_libs ${instance.veracruzTestElfInContext}/bin/veracruz-test
